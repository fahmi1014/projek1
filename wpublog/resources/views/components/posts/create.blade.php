     ...
     <form action="/dashboard" method="POST">
         ...
         <div class="mb-4">
             ...
             <textarea id="body" name="body" rows="4"
                 class="@error('body')
                  bg-red-50 border-red-500 text-red-500 placeholder-red-700 focus:ring-red-500 focus:border-red-500 
                  @enderror block p-2.5 w-full text-sm text-gray-900 rounded-lg border 
         ...
         <div class="flex gap-2">
             ...
             <a href="/dashboard"
                 class="inline-flex items-center text-whit bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                 Cancel
             </a>
         </div>
     </form>
