  <nav class="bg-gray-800 dark:bg-gray-800/50">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center justify-between">
              ...
              text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800
              focus:outline-hidden cursor-pointer">
                 ...
                 focus:bg-gray-100 focus:outline-hidden dark:text-gray-300 
                 dark:focus:bg-white/5">Log
                                      out</button>
                              </form>
                          </el-menu>
                      </el-dropdown>
