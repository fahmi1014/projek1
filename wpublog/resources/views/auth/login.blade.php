<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address and Username (User Credentials)-->
        <div>
            <x-input-label for="user_cred" :value="__('Email or Username')" />
            <x-text-input id="user_cred" class="block mt-1 w-full" type="text" 
            name="user_cred" :value="old('user_cred')" required autofocus autocomplete="user_cred" />
