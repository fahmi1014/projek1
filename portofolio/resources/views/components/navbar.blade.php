<nav class="bg-gray-800 dark:bg-gray-800/50">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
             ...
             <x-nav-link href="/cv" :current="request()->is('cv')">Cv</x-nav-link>
             <x-nav-link href="/portofolio" :current="request()->is('portofolio')">Portofolo</x-nav-link>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <x-nav-link class="block" href="/cv" :current="request()->is('cv')">Cv</x-nav-link>
        <x-nav-link class="block" href="/portofolio" :current="request()->is('portofolio')">Portofolio</x-nav-link>
